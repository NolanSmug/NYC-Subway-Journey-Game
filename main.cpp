...
int getRandomStationIndex(unsigned int numStations);
...
void selectChallenge(JourneyManager &journeyManager, LineName &startingLine, Station &startingStation, Station &destinationStation) {
    ...
    for (Challenge challenge : allChallenges) {
        cout << count << ": " << challenge.getStartStationName() << " -> " << challenge.getDestinationStationName() << endl;
        count++;
    }
    ...
    if (index >= 1 && index <= allChallenges.size()) {
        ...
        journeyManager.setStartingStation(challengeChoice.getStartStationName());
        journeyManager.setDestinationStation(challengeChoice.getDestinationStationName());
